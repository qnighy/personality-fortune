...
export function SlotUnit(props: SlotUnitProps): ReactElement | null {
  const { index, value, options, randValue, push, focus } = props;
            ...
            !value &&
              [firstOptionIndex, secondOptionIndex].map((index, i) => (
                <div key={`option-virtual-${i}`}
                  className="SlotUnit__option absolute w-45 h-60 left-0 text-abs-50 text-center align-middle filter-[url(#blur-vertical)] select-none"
